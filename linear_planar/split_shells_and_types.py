...
def main(dwifile, bvals, gtablefile, bmax, eddy_configfile, eddy_indicesfile, dwiout, bvecout, bvalout,
         eddy_indices_out, position_idx_out):
    ...
    # linear-planar detection (assumes only perfect linear and planar exist (eucl. dist. between g1 and g2 is 0 OR
    # sqrt(2)~1.4))
